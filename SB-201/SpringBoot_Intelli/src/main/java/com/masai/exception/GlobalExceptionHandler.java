...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<MyErrorDetails> myExHandler1(MethodArgumentNotValidException m){
        MyErrorDetails details = new MyErrorDetails(LocalDateTime.now(), "Validation Error", m.getMessage());
