...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> validatedException(MethodArgumentNotValidException validEx,WebRequest web){

		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
		err.setMessage("Validation error");
		err.setDetails(validEx.getBindingResult().getFieldError().getDefaultMessage());
